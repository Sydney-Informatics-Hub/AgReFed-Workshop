...
**Make sure to fill in the form with genuine answers.** In the section asking "What would you like to accomplish with Earth Engine?", provide a proper learning/academic reason, e.g. "I want to use Google Earth Engine to learn about remote sensing and image processing for my research". Note: please do not just copy and paste the response from here as Google may reject your application.

![](assets/gee_signup.jpg)
