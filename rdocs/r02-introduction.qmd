...
<!-- In **Session 2**, we will preview and manipulate downloaded data manually without the YAML config, and explore some Google Earth Engine functionality.

**Session 3** will introduce to you some of the more advanced features of `dataharvester` including the ability to preprocess data and create custom data products. -->
